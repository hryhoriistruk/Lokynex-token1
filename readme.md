...
*example*: [Reentrant.sol](../../Downloads/LOKUNEX/src/Reentrant.sol)
...
*example*: [MissingReturns.sol](../../Downloads/LOKUNEX/src/MissingReturns.sol)  
*example*: [ReturnsFalse.sol](../../Downloads/LOKUNEX/src/ReturnsFalse.sol)
...
*example*: [TransferFee.sol](../../Downloads/LOKUNEX/src/TransferFee.sol)
...
*example*: [Upgradable.sol](../../Downloads/LOKUNEX/src/Upgradable.sol)
...
*example*: [BlockList.sol](../../Downloads/LOKUNEX/src/BlockList.sol)
...
*example*: [Pausable.sol](../../Downloads/LOKUNEX/src/Pausable.sol)
...
*example*: [Approval.sol](../../Downloads/LOKUNEX/src/Approval.sol)
...
*example*: [ApprovalToZeroAddress.sol](../../Downloads/LOKUNEX/src/ApprovalToZeroAddress.sol)
...
*example*: [ApprovalWithZeroValue.sol](../../Downloads/LOKUNEX/src/ApprovalWithZeroValue.sol)

## Revert on Zero Value Transfers

Some tokens (e.g. `LEND`) revert when transferring a zero value amount.

*example*: [RevertZero.sol](../../Downloads/LOKUNEX/src/RevertZero.sol)
...
*example*: [Proxied.sol](../../Downloads/LOKUNEX/src/Proxied.sol)
...
*example*: [LowDecimals.sol](../../Downloads/LOKUNEX/src/LowDecimals.sol)
...
*example*: [HighDecimals.sol](../../Downloads/LOKUNEX/src/HighDecimals.sol)
...
- [ERC20.sol](../../Downloads/LOKUNEX/src/ERC20.sol): does not attempt to decrease allowance
- [TransferFromSelf.sol](../../Downloads/LOKUNEX/src/TransferFromSelf.sol): always attempts to decrease the allowance
...
*example*: [Bytes32Metadata.sol](../../Downloads/LOKUNEX/src/Bytes32Metadata.sol)
...
*example*: [RevertToZero.sol](../../Downloads/LOKUNEX/src/RevertToZero.sol)
...
*example*: [NoRevert.sol](../../Downloads/LOKUNEX/src/NoRevert.sol)
...
*example*: [Uint96.sol](../../Downloads/LOKUNEX/src/Uint96.sol)
...
*example*: [DaiPermit.sol](../../Downloads/LOKUNEX/src/DaiPermit.sol)
